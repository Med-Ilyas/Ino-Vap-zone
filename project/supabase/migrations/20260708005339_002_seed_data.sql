/*
# Seed Categories and Sample Products for INO-VAP ZONE
...
2. Products (20 sample products distributed across categories)
- 2 products per category
- Each with SKU, name, description, technical specs, material, sizes
...
- Product images use stock photos
- PDF datasheets use placeholder URLs (to be updated in production)
*/
